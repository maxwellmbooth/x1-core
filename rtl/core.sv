...
module core (
    ...
    stage_id stage_id_inst (
        ...
        .ctrl_id_i(ctrl_id),
        .if_id_i(if_id),
        .ready_ds_i(ex_ready_us),
        .rs1_data_i(rs1_data),
        .rs2_data_i(rs2_data),
        .rs1_addr_o(rs1_addr),
        .rs2_addr_o(rs2_addr),
        .ready_us_o(id_ready_us),
        .info_id_o(info_id),
        .id_ex_o(id_ex)
    );
    ...
    stage_ex stage_ex_inst (
        ...
        .ctrl_ex_i(ctrl_ex),
        .id_ex_i(id_ex),
        .ready_ds_i(mem_ready_us),
        .pc_redirect_o(pc_redirect),
        .ready_us_o(ex_ready_us),
        .ex_mem_o(ex_mem)
    );
